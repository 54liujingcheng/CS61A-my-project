...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        child_formals = formals
        child_vals = vals
        while child_formals != nil:
            child_frame.define(child_formals.first, child_vals.first)
            child_formals = child_formals.rest
            child_vals = child_vals.rest
        return child_frame
        # END PROBLEM 8
